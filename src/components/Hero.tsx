      ...
      <section class="relative">
        ...
        <div class="absolute inset-0 flex flex-col items-center justify-center text-center px-4 md:px-20">
          ...
          <div class="flex flex-col sm:flex-row gap-4">
            <button onClick={handleBooking} class="px-6 py-3 text-white bg-[#AD343E] rounded-full hover:opacity-90 transition">
              Book a Table
            </button>

            <button onClick={handleMenuList} class="px-6 py-3 text-black bg-white border border-black rounded-full hover:bg-gray-100 transition">
              Explore Menu
            </button>
          </div>
